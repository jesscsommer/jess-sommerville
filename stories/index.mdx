...
During my time in product support, I worked at a no-code startup called Bubble. The company works on an app builder with a drag-and-drop editor and a spreadsheet-like database management interface. My time there brought me closer to software engineering and taught me the fundamentals of web development, even before I’d written a line of JavaScript. This led me to decide to deepen my technical knowledge and enroll at Flatiron School for full-stack software engineering.
